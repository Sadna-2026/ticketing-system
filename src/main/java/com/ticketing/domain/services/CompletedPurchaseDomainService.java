...
public class CompletedPurchaseDomainService {

    private static final Logger log = LoggerFactory.getLogger(CompletedPurchaseDomainService.class);
    ...
    public CompletedPurchaseDomainService(
