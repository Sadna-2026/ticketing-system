...
public class HomeView extends VerticalLayout implements BeforeEnterObserver {
    ...
    private Div actionCard(VaadinIcon icon, String title, String description,
            Class<? extends Component> target) {
        Div card = new Div();
        card.addClassName("app-action-card");
        ...
        card.add(glyph, heading, desc);
        // Navigate on click instead of resolving a route at construction time, so the
        // view can be unit-constructed without an active VaadinService/router.
